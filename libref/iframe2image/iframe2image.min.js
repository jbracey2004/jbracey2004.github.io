...
}(typeof exports === 'object' && exports || this));same domain");var r=n.contentWindow.document;if(r&&r.readyState==="complete")s();else{function i(e){n.removeEventListener("load",i),s()}n.addEventListener("load",i)}}e.iframe2image=t}(typeof exports=="object"&&exports||this);